...
export class MicrosoftComponent {
  ...
  generateGraph() {
    ...
    const url = `https://finnhub.io/api/v1/stock/candle?symbol=MSFT&resolution=D&from=${oneYearAgoTimestamp}&to=${currentTimestamp}&token=cc676uaad3i9rj8tb1s0`;
  ...
  ngOnInit() {
    this.userService.msft().subscribe((data)=>{
